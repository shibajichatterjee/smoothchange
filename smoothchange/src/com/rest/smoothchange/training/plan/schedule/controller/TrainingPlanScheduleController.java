...
public class TrainingPlanScheduleController {
	...
	public ResponseEntity trainingPlanScheduleCreate(@RequestHeader("API-KEY") String apiKey,
			@RequestParam("projectId") String id,
			@RequestBody TrainingPlanScheduleRequestDto trainingPlanScheduleRequestDto)
		...
		if (projectBackgroundDto != null && projectBackgroundDto.getId() != null) {
			...
			trainingPlanScheduleDto = mapTrainingPlanScheduleRequestDtoToDto(trainingPlanScheduleDto,
					trainingPlanScheduleRequestDto);
	...
	public ResponseEntity trainingPlanScheduleModify(@RequestHeader("API-KEY") String apiKey,
			@RequestParam("projectId") String id,
			@RequestBody TrainingPlanScheduleRequestDto trainingPlanScheduleRequestDto)
			throws NoRecordsFoundException, ParseException, UnauthorizedException {
		...
		ResponseBean responseBean = new ResponseBean();
		TrainingPlanScheduleDto trainingPlanScheduleDto = trainingPlanScheduleService
				.getById(trainingPlanScheduleRequestDto.getTrainingPlanScheduleId());
	...
	public ResponseEntity getTrainingPlanScheduleById(@RequestHeader("API-KEY") String apiKey,
			@RequestParam("trainingPlanScheduleById") long trainingPlanScheduleById)
			throws NoRecordsFoundException, ParseException, UnauthorizedException {
		...
		ResponseBean responseBean = new ResponseBean();
		if (trainingPlanScheduleDto != null && trainingPlanScheduleDto.getId() != null) {
			TrainingPlanScheduleRequestDto trainingPlanScheduleRequestDto = mapTrainingPlanScheduleDtoToRequestDto(
					trainingPlanScheduleDto);
	...
	public ResponseEntity getTrainingPlanScheduleByProjectId(@RequestHeader("API-KEY") String apiKey,
		...
		List<TrainingPlanScheduleDto> trainingPlanScheduleList = trainingPlanScheduleService
				.getTrainingPlanScheduleListByProjectId(projectId);
		ResponseBean responseBean = new ResponseBean();
	...
	@RequestMapping(value = "/deleteTrainingPlanSchedule", method = RequestMethod.DELETE)
	public ResponseEntity deleteTrainingPlanSchedule(@RequestHeader("API-KEY") String apiKey,
			@RequestParam("id") long trainingPlanScheduleId) throws UnauthorizedException, NoRecordsFoundException {
		if (!apiKey.equals(MessageEnum.API_KEY)) {
			throw new UnauthorizedException(MessageEnum.unathorized);
		}
		TrainingPlanScheduleDto trainingPlanScheduleDto = trainingPlanScheduleService.getById(trainingPlanScheduleId);

		if (trainingPlanScheduleDto != null && trainingPlanScheduleDto.getId() != null) {
			trainingPlanScheduleService.delete(trainingPlanScheduleDto);
		} else {
			throw new NoRecordsFoundException(MessageEnum.enumMessage.NO_RECORDS.getMessage());
		}
		ResponseBean responseBean = new ResponseBean();
	...
	private TrainingPlanScheduleDto mapTrainingPlanScheduleRequestDtoToDto(
			TrainingPlanScheduleDto trainingPlanScheduleDto,
			TrainingPlanScheduleRequestDto trainingPlanScheduleRequestDto) throws ParseException {
		if (trainingPlanScheduleRequestDto != null) {
			...
			if (trainingPlanScheduleRequestDto.getDateTime() != null
					&& !trainingPlanScheduleRequestDto.getDateTime().trim().equals("")) {
				trainingPlanScheduleDto.setDateTime(
						DateUtil.getFormattedDate(trainingPlanScheduleRequestDto.getDateTime(), dateFormate));
			}
	...
	private TrainingPlanScheduleRequestDto mapTrainingPlanScheduleDtoToRequestDto(
			TrainingPlanScheduleDto trainingPlanScheduleDto) throws ParseException {
		...
		if (trainingPlanScheduleDto != null) {
			...
			if (trainingPlanScheduleDto.getDateTime() != null) {
				trainingPlanScheduleRequestDto.setDateTime(
						DateUtil.getFormattedDateStringFromDate(trainingPlanScheduleDto.getDateTime(), dateFormate));
			}
