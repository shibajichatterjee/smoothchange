 ...
 * 
 */
package com.rest.smoothchange.action.plan.business.unit.items.entity;
...
@Entity
@Table(name = "ACTION_PLAN_BUSINESS_UNIT_ITEMS")
public class ActionPlanBusinessUnitItems extends AbstractIdentifierObject{
