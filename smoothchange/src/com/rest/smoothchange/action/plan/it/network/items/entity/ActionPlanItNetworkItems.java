 ...
 * 
 */
package com.rest.smoothchange.action.plan.it.network.items.entity;
...
@Entity
@Table(name = "ACTION_PLAN_IT_NETWORK_ITEMS")
public class ActionPlanItNetworkItems extends AbstractIdentifierObject{
