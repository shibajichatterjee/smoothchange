 ...
 * 
 */
package com.rest.smoothchange.action.plan.project.team.items.entity;
...
@Entity
@Table(name = "ACTION_PLAN_PROJECT_TEAM_ITEMS")
public class ActionPlanProjectTeamItems extends AbstractIdentifierObject{
