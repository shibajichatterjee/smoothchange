 ...
 * 
 */
package com.rest.smoothchange.action.plan.communication.items.entity;
...
@Entity
@Table(name = "ACTION_PLAN_COMMUNICATION_ITEMS")
public class ActionPlanCommunicationItems extends AbstractIdentifierObject{
