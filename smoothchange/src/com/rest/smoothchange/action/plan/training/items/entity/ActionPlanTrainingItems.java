 ...
 * 
 */
package com.rest.smoothchange.action.plan.training.items.entity;
...
@Entity
@Table(name = "ACTION_PLAN_TRAINING_ITEMS")
public class ActionPlanTrainingItems extends AbstractIdentifierObject{
